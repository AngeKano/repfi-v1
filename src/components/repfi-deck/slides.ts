...
export const processSteps = [
  {
    ...
    desc: "Importez votre Grand Livre Général.",
  },
  {
    num: "02",
    icon: "ListChecks",
    title: "Plan des Comptes",
    desc: "Importez votre Plan des Comptes.",
  },
  {
    num: "03",
    icon: "Users",
    title: "Plan Tiers",
    desc: "Importez votre Plan Tiers.",
  },
  {
    num: "04",
    icon: "Columns3",
    title: "Codes Journaux",
    desc: "Importez la liste des Codes Journaux.",
  },
] as const;
...
export const kpis: Kpi[] = [
  ...
  },
  {
    ...
    trend: "up",
    chart: "bars",
    data: [40, 55, 48, 62, 70, 85],
  },
  {
    label: "Taux de recouvrement client",
    value: "92,4 %",
    delta: "+6,7 pts",
    trend: "up",
    chart: "gauge",
  ...
  {
    label: "Taux de décaissement fournisseur",
    value: "88,1 %",
    delta: "-3,2 pts",
    trend: "down",
    chart: "gauge",
...
export const decisions = [
  ...
  {
    icon: "Handshake",
    text: "Optimisez vos relations clients et fournisseurs",
  },
...
export const contact = [
  { icon: "", text: "Démo adaptée à votre cabinet ou entreprise" },
  { icon: "", text: "Réponse sous 24 h ouvrées" },
